...
#define LOW_PRECISION`),e}function Fp(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===hl?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===dl?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===fn&&(e="SHADOWMAP_TYPE_VSM"),e}function Op(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Ai:case Ci:e="ENVMAP_TYPE_CUBE";break;case js:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Bp(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Ci:e="ENVMAP_MODE_REFRACTION";break}return e}function kp(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case ul:e="ENVMAP_BLENDING_MULTIPLY";break;case Sc:e="ENVMAP_BLENDING_MIX";break;case bc:e="ENVMAP_BLENDING_ADD";break}return e}function zp(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Vp(s,e,t,n){const i=s.getContext(),a=t.defines;let r=t.vertexShader,o=t.fragmentShader;const l=Fp(t),c=Op(t),h=Bp(t),d=kp(t),u=zp(t),p=Cp(t),g=Rp(a),v=i.createProgram();let m,f,T=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+f);const E=T+m+r,y=T+f+o,N=Fo(i,i.VERTEX_SHADER,E),A=Fo(i,i.FRAGMENT_SHADER,y);i.attachShader(v,N),i.attachShader(v,A),t.index0AttributeName!==void 0?i.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(v,0,"position"),i.linkProgram(v);function w(C){if(s.debug.checkShaderErrors){const k=i.getProgramInfoLog(v).trim(),F=i.getShaderInfoLog(N).trim(),W=i.getShaderInfoLog(A).trim();let $=!0,X=!0;if(i.getProgramParameter(v,i.LINK_STATUS)===!1)if($=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,v,N,A);else{const Q=Bo(i,N,"vertex"),G=Bo(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(v,i.VALIDATE_STATUS)+`
      ...
      `}),this.quad=new He(new Mn(2,2),this.blendMaterial),this.blendScene.add(this.quad),this.resultCanvas=document.createElement("canvas")}startExposure(e){this.isExposingFlag=!0,this.duration=0,this.startTime=performance.now(),this.sampleCount=0,this.renderer.setRenderTarget(this.rtA),this.renderer.clear(),this.renderer.setRenderTarget(this.rtB),this.renderer.clear(),this.renderer.setRenderTarget(null),this.bufferIdx=0}getElapsedSeconds(){return this.isExposingFlag?(performance.now()-this.startTime)/1e3:0}getSampleCount(){return this.sampleCount}accumulate(e,t,n=1){if(!this.isExposingFlag)return;this.sampleCount++,this.renderer.setRenderTarget(this.frameTarget),this.renderer.render(e,t);const i=this.bufferIdx===0?this.rtA:this.rtB,a=this.bufferIdx===0?this.rtB:this.rtA;this.blendMaterial.uniforms.uCurrentFrame.value=this.frameTarget.texture,this.blendMaterial.uniforms.uAccumulatedFrame.value=i.texture,this.blendMaterial.uniforms.uSampleCount.value=this.sampleCount,this.blendMaterial.uniforms.uExposureGain.value=n,this.renderer.setRenderTarget(a),this.renderer.render(this.blendScene,this.blendCamera),this.renderer.setRenderTarget(null),this.bufferIdx=1-this.bufferIdx}finishExposure(){const e=this.getElapsedSeconds();this.isExposingFlag=!1;const t=this.bufferIdx===0?this.rtA:this.rtB;this.resultCanvas.width=this.width,this.resultCanvas.height=this.height;const n=this.resultCanvas.getContext("2d");if(!n)return e;const i=new Uint16Array(this.width*this.height*4);this.renderer.readRenderTargetPixels(t,0,0,this.width,this.height,i);const a=n.createImageData(this.width,this.height);for(let o=0;o<i.length;o++)a.data[o]=Math.min(255,Math.max(0,Eh.fromHalfFloat(i[o])*255));const r=n.createImageData(this.width,this.height);for(let o=0;o<this.height;o++)for(let l=0;l<this.width;l++){const c=(o*this.width+l)*4,h=((this.height-1-o)*this.width+l)*4;r.data[h]=a.data[c],r.data[h+1]=a.data[c+1],r.data[h+2]=a.data[c+2],r.data[h+3]=a.data[c+3]}return n.putImageData(r,0,0),e}getResultAsDataUrl(){return this.resultCanvas.toDataURL("image/jpeg",.85)}isExposing(){return this.isExposingFlag}getProgress(){return this.isExposingFlag?1:0}getAccumulatedTexture(){return(this.bufferIdx===0?this.rtA:this.rtB).texture}resize(e,t){this.width=e,this.height=t,this.rtA.setSize(e,t),this.rtB.setSize(e,t),this.frameTarget.setSize(e,t)}dispose(){this.rtA.dispose(),this.rtB.dispose(),this.frameTarget.dispose(),this.blendMaterial.dispose()}}const Kl={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Di.BlurDirectionX=new Ae(1,0);Di.BlurDirectionY=new Ae(0,1);const R0={uniforms:{tDiffuse:{value:null},darkness:{value:.3},offset:{value:1}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
