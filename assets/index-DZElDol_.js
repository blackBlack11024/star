...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:vn,depthTest:!1,depthWrite:!1})}function Ro(){return new pt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Br(),fragmentShader:`
		...
		`,blending:vn,depthTest:!1,depthWrite:!1})}function Po(){return new pt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Br(),fragmentShader:`
...
`)+`
`+f);const E=x+m+r,b=x+f+o,L=Bo(i,i.VERTEX_SHADER,E),C=Bo(i,i.FRAGMENT_SHADER,b);i.attachShader(v,L),i.attachShader(v,C),t.index0AttributeName!==void 0?i.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(v,0,"position"),i.linkProgram(v);function w(A){if(s.debug.checkShaderErrors){const B=i.getProgramInfoLog(v).trim(),F=i.getShaderInfoLog(L).trim(),O=i.getShaderInfoLog(C).trim();let W=!0,q=!0;if(i.getProgramParameter(v,i.LINK_STATUS)===!1)if(W=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,v,L,C);else{const Q=zo(i,L,"vertex"),X=zo(i,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(v,i.VALIDATE_STATUS)+`
